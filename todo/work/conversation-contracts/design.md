# Conversation and approval contract design

> Retained design record. The contracts were implemented; this is not a current
> execution plan. The original approvals, blockers, and commands below describe
> that slice at the time. See [the retained work record](README.md), current
> source code, and [live priorities](../../TODO.md) before continuing work.
...
[../conversation-library.md](../../../docs/conversation-library.md).
...
- [the shared conversation contract](README.md) owns `src/benchwarmer/conversations.py`,
  `tests/test_conversations.py`, and `tests/fixtures/conversations/`.
- [the bounded approval contract](README.md) owns `src/benchwarmer/model_work.py` and
...
## Add shared conversation records and synthetic source examples: Normalized conversation v1

**Type:** Subsystem or file cluster `[context: medium]`.
**Dependencies:** [the conversation-library design](../../../docs/conversation-library.md), existing [Python quality tooling](../application-foundation/plan.md) tooling; no database dependency.
...
## Add bounded model-work plans and exact approval validation: Bounded model-work preview and approval

**Type:** Focused change `[context: medium]`.
**Dependencies:** [the conversation-library design](../../../docs/conversation-library.md), existing [Python quality tooling](../application-foundation/plan.md) tooling; independent of [the shared conversation contract](README.md).
...
canonical checks that remain blocked. Record completion only with truthful acceptance evidence; retain any
validation blocker in the work record. Current closeout follows the workbench.
No live source, inference, network service, browser, or durable budget protection
may be claimed from this slice.

[the accepted collection decision](../../../docs/decisions/0005-cross-machine-collection.md) was later resolved in
[ADR 0005](../../../docs/decisions/0005-cross-machine-collection.md). Finish the necessary
